...
addpath('E:\lcl\data\small90_tracker_benchmark_v1.0/util');

pathRes = 'E:\lcl\tracking\results\results_OPE_CVPR13\UAV123\'%'E:\lcl\tracking\results\results_OPE_CVPR13\results_OPE_CVPR13_1\results_OPE_CVPR13_1\';% The folder containing the tracking results
pathDraw = 'E:\lcl\data\small90_tracker_benchmark_v1.0\tmp\imgs\';% The folder that will stores the images with overlaid bounding box
