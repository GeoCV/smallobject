...
%attPath = 'F:\data\UAV123_10fps\anno\UAV123_10fps\att\'; % The folder that contains the annotation files for sequence attributes
...
attFigName={'illumination variation'	'scale variation'	'occlusion'	'deformation'	'motion blur'	'fast motion'	'in-plane rotation'	'out-of-plane rotation' 'out of view'	'background clutter' 'low resolution'};
...
plotDrawStyle10={   struct('color',[1,0,0],'lineStyle','-'),...
    ...
    struct('color',[0,0,0],'lineStyle','-'),...%    struct('color',[1,1,0],'lineStyle','-'),...%yellow
    struct('color',[1,0,1],'lineStyle','--'),...%pink
    struct('color',[0,1,1],'lineStyle',':')};%{   struct('color',[1,0,0],'lineStyle','-')};
%     ,...
%     struct('color',[0,1,0],'lineStyle','--'),...
%     struct('color',[0,0,1],'lineStyle',':'),...
%     struct('color',[0,0,0],'lineStyle','-'),...%    struct('color',[1,1,0],'lineStyle','-'),...%yellow
...
figPath = 'E:\tracking\figs\overall\';

perfMatPath = 'E:\tracking\perfMat\overall\';
...
evalTypeSet = { 'OPE'};%, 'OPE','SRE'

rankingType = 'threshold';%AUC,AUC 
